...
public class HandCollider : MonoBehaviour
{
    ...
    public Vector3 poiScreenPosition;
    ...
    void Update()
    {
        ...
        poiScreenPosition = tracking.poi;
        ...
        currentPosition = Camera.main.ViewportToWorldPoint(new Vector3(poiScreenPosition.x, poiScreenPosition.y, tracking.depth_estimation));
